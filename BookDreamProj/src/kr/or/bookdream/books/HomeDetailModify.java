...
public class HomeDetailModify extends JPanel {
	...
	public HomeDetailModify() {
		...
		lblNewLabel.setIcon(new ImageIcon(HomeDetailModify.class.getResource("/javax/swing/plaf/basic/icons/image-failed.png")));
