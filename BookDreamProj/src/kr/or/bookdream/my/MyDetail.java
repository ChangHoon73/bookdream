...
public class MyDetail extends JPanel {
	 ...
	 */
	public MyDetail(MainView mMainView){
		this.mMainView = mMainView;
		initialize(); //  추가
	}
	
	public MyDetail(MainView mMainView, int booksno) {
		this.mMainView = mMainView;
	...
	private void initialize() {
		...
		lbl_image.setIcon(new ImageIcon(MyDetail.class.getResource("/javax/swing/plaf/basic/icons/image-failed.png")));
		...
		btn_add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(mMainView.isbLogin()){ // 로그인시
					// HomeDetailAdd 패널 호출
					mMainView.setDetailPanel(new MyDetailAdd(mMainView));
				}else{ // 비로그인시
