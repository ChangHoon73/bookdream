...
public class MyDetailAdd extends JPanel {
	 ...
	 * Create the panel.
	 */
	public MyDetailAdd(MainView mMainView) {
		...
		lbl_Image.setIcon(new ImageIcon(MyDetailAdd.class.getResource("/javax/swing/plaf/basic/icons/image-failed.png")));
